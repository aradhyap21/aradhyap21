<h1 align="center">Hi 👋, I'm Aradhya Rahul Pandey</h1>
...
**AI / ML**
`PyTorch` `HuggingFace Transformers` `LLM Fine-tuning` `RAG` `LangGraph` `MCP` `BART` `OpenAI API`

**Frameworks & Tools**
`FastAPI` `Pandas` `Streamlit`

**Cloud & DevOps**
`AWS (SageMaker, Bedrock)` `Docker` `GitHub Actions` `SonarQube`

---

### 💼 Experience

**ML Intern — Solid State & Structural Chemistry Unit, IISc Bengaluru**
*Jan 2026 – Jun 2026*
- Built **RoboChemist**, an AI-powered autonomous lab platform automating the full experimentation lifecycle (design → execution → PDF report)
- Engineered a Master AI orchestrator accepting plain-English or GUI input to schedule trials, analyze sensor data, and auto-optimize reaction parameters

**Software Engineering Intern — ARTPARK (AI & Robotics Technology Park), Bengaluru**
*Jun 2025 – Jul 2025*
- Cut manual QA effort by 30% by engineering a GitHub Actions + SonarQube CI/CD pipeline (85% line coverage); reduced regressions by 40% with 50+ pytest tests
- Deployed a real-time license plate detection system (YOLOv8 + EasyOCR) achieving 91% accuracy on 2,000+ test images
...
- Built a weighted late-fusion layer (text/face/audio) with user-adjustable weights, served via FastAPI

---

### 📜 Certifications

- 🥇 AWS Certified Machine Learning Engineer — Associate *(Apr 2026)*
